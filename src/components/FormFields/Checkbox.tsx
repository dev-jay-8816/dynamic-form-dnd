                            ...
                            ? options?.map((opt) => {
                                return (
                                    <div key={opt?.value} className="form-check">
                                        <Field className="form-check-input" type="checkbox" name={name} value={opt?.value} id={opt?.value?.toString()} />
                            ...
                            : options?.map((opt) => {
                                return (
                                    <div key={opt} className="form-check">
                                        <Field className="form-check-input" type="checkbox" name={name} value={opt} id={opt} />
